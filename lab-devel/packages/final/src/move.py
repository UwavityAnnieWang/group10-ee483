...
import os
import numpy as np
from duckietown_msgs.msg import WheelsCmdStamped, Pose2DStamped # Import the message for the wheel comm
...
class Driver():#CHANGE CLASSNAME to the name of your class
    def __init__(self):
        ...
        self.drivePub = rospy.Publisher('/ee483mm10/wheels_driver_node/wheels_cmd', WheelsCmdStamped, queue_size=10)
        self.driveOdom = rospy.Publisher('/ee483mm10/velocity_to_pose_node/pose', Pose2DStamped, queue_size=10)
